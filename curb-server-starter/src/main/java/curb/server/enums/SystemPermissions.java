...
public enum SystemPermissions {
    ...
    SYSTEM_API_PAGE_GET("/system/api/page/get", "页面详情查询"),
    SYSTEM_API_PAGE_CREATE("/system/api/page/create", "新建页面"),
    SYSTEM_API_PAGE_UPDATE("/system/api/page/update", "修改页面"),
    SYSTEM_API_PAGE_CONFIG_GET("/system/api/page/config/get", "查看访问控制"),
    SYSTEM_API_PAGE_CONFIG_SAVE("/system/api/page/config/save", "修改访问控制"),
